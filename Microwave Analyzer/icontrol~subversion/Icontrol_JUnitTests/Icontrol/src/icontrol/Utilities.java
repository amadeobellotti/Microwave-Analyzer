...
//        }
     ...
     * Unit tests, the <code>GUI_Interface</code> of the <code>TestMockup</code>
     * is returned.
     * 
     * @return The <code>GUI_Interface</code> of the <code>IcontrolApp</code> or
     * of the <code>TestMockup</code>.
     */
    public static GUI_Interface getView() {
        ...
        if (ret == null) {         
            ...
            // yes, so get the GUI from the TestMockup
            ret = TestMockup.getView();
