...
public class Device {
     ...
     * sending if in No-Communication-Mode.<p>
     *
     ...
     *
     * @param Message that will be logged and sent to the Instrument
    ...
    protected final void SendToInstrument(String Message)
                    throws IOException {
    ...
    protected final String QueryInstrument(String Message)
                    throws IOException {
