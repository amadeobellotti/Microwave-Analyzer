// TODO first: read comment at Utilities.getView becuase it fails
// TODO next: implement getFileName, check graphs
// rename TestMockup to IcontrolAppMockup
// setup Loggers
// don't use a Frame, it's not visible after test ends, just use System.out
// fix Keithley2600 to use solution from [math]
// could i use StopOrGo to wait before Tearing down the class?

// for javadoc:
/* Utilities has a getView method which either returns the "real" GUI when iC
 * is started as a "regular" application, or it returns the MockupView when
 * iC is unit tested. To be more precise, it returns the GUI_Interface
 * 
 * Every test class should instantiate MockupTest, which creates a Mockup View, 
 * instantiates an appropriate Dispatcher, assigns Loggers, etc.
 * 
 */
 ...
 *
 */
public class Keithley2600Test {
    
    public Keithley2600Test() {
    }
    
    // needs to be static because it's accessed in @BeforeClass which needs to be
    // static
    private static TestMockup m_TestMockups;
    
    
    // TODO 4* could be in a test superclass
    @BeforeClass
    public static void setUpClass()  {
        ...
        // instantiate Test Mockups
        m_TestMockups = new TestMockup();
                
        
        // toc
        int dt = Math.round( System.currentTimeMillis() - tic );
        System.out.println("Set up Mockup View in " + dt + " ms");
    ...
    /**
     * Uses measured data to test the algorithm used to evalueate the OPVs.
     */
    @Test(timeout=3*1000+1000)
    public void EvaluateOPV() {
        ...
        // TODO try making a non-modal dialog and display it in tearDown. put
        // the non-modal dialog in testMockup
        ...
        TestMockup.getView().DisplayStatusMessage(
                "--->EvaluateOPV test: inspect the text and graphic files generated in ..."
