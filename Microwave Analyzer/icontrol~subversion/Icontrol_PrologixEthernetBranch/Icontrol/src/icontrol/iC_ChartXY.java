 ...
 * traces by invoking <code>AddXYDataPoint</code>.<p>
 *
 ...
 *  <li>m_Chart.getXAxis().setNumberFormatOverride(new DecimalFormat("0"));
...
public class iC_ChartXY extends JFrame implements ActionListener {
     ...
     * On a few occasions iC crashed the Java VM without much info what cuased the
     ...
     * are not GC automatically, which is a known problem but iC ony uses
     ...
     * since the last GC.
     */
    // TODO 3* check if manually starting GC evey 100 data points helps
     ...
     *
     * @param PreferredWidth The preferred width of the JFrame. If a value below
     * 0 is specified, the default size is set to 640x480.
     *
     * @param PreferredHeight The preferred height of the JFrame. If a value below
     * 0 is specified, the default size is set to 640x480.
     */
     ...
     * and <code>AddXYDataPoint</code> to add data points. Called by the Constructor.
    ...
    /**
     * Adds a new trace (XYSeries) to the Chart. Allows to chose which Y-axis
    ...
    public SeriesIdentification AddXYSeries( String SeriesName,
        ...
        if (dummy > 0) {
            ...
            IcontrolView.DisplayStatusMessage("Limiting the number of Data Points kept in series '" 
                    + SeriesName + "' to " + dummy + "\n", false);
        }
     ...
     *
     * @return The index of the newly created axis to be used to access the Data
     ...
     */
    // <editor-fold defaultstate="collapsed" desc="new Y axis">
    public int newYaxis(String Label) {
        ...
        // return the index of the newly added DataSeriesCollection
        return SeriesIndex;
    }//</editor-fold>
     ...
     * contains an <code>AxisIndex</code> which is out of bounds.<p>
     * 
     ...
     */
    // <editor-fold defaultstate="collapsed" desc="Add XY Data Point">
    ...
    /**
     * Same as {@link #AddXYDataPoint(SeriesIdentification, double, double)} but with arrays as
     ...
     */
    // <editor-fold defaultstate="collapsed" desc="Add XY Data Point (array)">
    public void AddXYDataPoint(SeriesIdentification SeriesID, double[] X, double[] Y) {
        ...
        try {
            ...
            // increase counter for Garbage Collection (GC is started in the other AddXYDataPoint)
    ...
    public void LogXAxis(boolean LogAxis) {
        ...
        if (LogAxis == true) {
            ...
            // TODO 3* what happens if I show positive and negative numbers on a log scale
    ...
    public void LogYAxis(boolean LogAxis) {
        ...
        if (LogAxis == true) {
            ...
            // TODO 5* fix displaying data on a log scale 
            // maybe I need to AutoRange or set min/max values myself
        } else {
            // make a new lin axis
