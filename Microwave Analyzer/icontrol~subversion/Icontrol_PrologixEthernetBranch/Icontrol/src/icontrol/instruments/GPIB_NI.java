...
//        void WaitSRQ       (int boardID, ShortByReference result);//PSHORT result
    ...
    protected void Open(int GPIB_Address)
        ...
        if (USE_4882 == true) {
            ...
            try {
                ...
                // show it to the user
                IcontrolView.DisplayStatusMessage("Warning: " + str, false);
            }
    ...
    protected long Send(String Msg)
        ...
        // Device.invokeGenericScriptMethod uses QueryViaGPIB("") to query the
        ...
        ByteBuffer BBuffer = ByteBuffer.wrap(Msg.getBytes());
     ...
     */
    // <editor-fold defaultstate="collapsed" desc="Close Device">
