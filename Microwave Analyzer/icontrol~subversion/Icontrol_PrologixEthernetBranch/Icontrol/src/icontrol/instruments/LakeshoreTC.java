...
public class LakeshoreTC extends Device {
     ...
     * @throws DataFormatException If Syntax-Check failed.
     */
    // <editor-fold defaultstate="collapsed" desc="check Input Channel">
     ...
     * <code>Time</code> before the method returns.<p>
     *
     ...
     * @param Tolerance Specify the maximum allowed temperature variation to 
     * qualify for a stable temperature
    ...
    @AutoGUIAnnotation(
        ...
        ParameterNames = {"Loop# {0,1,2,(3,...)}", "Temperature [unit of SetPoint]", "Wait until SP reached?",
                          "Temperature Tolerance [unit of SP]", "Stabilization Time [s]"},
    ...
    public void setTemp(int Loop, float Temperature, boolean Wait, float Tolerance, float Time)
        ...
        if (m_UsedCommPort == CommPorts.GPIB) {
            ...
            if (Wait) {
                ...
                do {
                    // if scripting is paused, wait wait until un-paused
    ...
    public void autoSetPoint(String InputChannel, int Loop)
        ...
        if (m_UsedCommPort == CommPorts.GPIB) {
            ...
            String RampParams = QueryViaGPIB("RAMP? " + Loop);
            ...
            SendViaGPIB("RAMP " + Loop + "," + RampParams);
    ...
    //TODO delme when manuscript finished
    /*
    @AutoGUIAnnotation(
	DescriptionForUser = "Adjusts the temperature.",
     ...
     * <code>SendViaGPIB</code>.
     *
     * {@link iC_Annotation#MethodChecksSyntax() }
     */
    // <editor-fold defaultstate="collapsed" desc="Configure Input Curve Number">
    @AutoGUIAnnotation(
     ...
     *
     * @throws IOException thrown by <code>QueryViaGPIB</code>
     *
     ...
     * @throws DataFormatException if Syntax-Check failed
     *
     * @see Device#QueryViaGPIB(String)
     * @see Device#getFloat(String)
     */
    ...
    public float getTemp(String InputChannel)
        ...
        if (m_UsedCommPort == CommPorts.GPIB) {
            ...
            String ans = QueryViaGPIB("KRDG? " + InputChannel);

            // convert
            ret = getFloat(ans);
            
            // get status of the input channel
            String Status = QueryViaGPIB("RDGST? " + InputChannel);
            ...
            String InputCurve = QueryViaGPIB("INCRV? " + InputChannel);
     ...
     *
     * @throws IOException re-thrown from {@link Device#QueryViaGPIB} or
     * <code>Device#SendViaGPIB</code>.
     *
     ...
     */
    // <editor-fold defaultstate="collapsed" desc="enable Heater Output">
    @AutoGUIAnnotation(
        DescriptionForUser = "Enables/Disables the Heater output.",
    ...
    public void enableHeaterOuput(boolean HeaterState)
        ...
        if (m_UsedCommPort == CommPorts.GPIB) {
            ...
            if (HeaterState == true) {
                ...
                m_LastHeaterRange = getInteger( QueryViaGPIB("RANGE?") );
    ...
    public void monitorTemp(String InputChannel, float TimeIntervall, String FileExtension)
        ...
        class myThread extends Thread {
            ...
            public void run() {
                ...
                while ( m_StopScripting == false) {
                    ...
                    try {
                        ...
                        if ( !inNoCommunicationMode() ) {
                            ...
                            IcontrolView.DisplayStatusMessage("Error reading temperature in MonitorTemp.\n");

                        } else {
                            IcontrolView.DisplayStatusMessage("Monitoring temperature in No-Communication-Mode.\n");
                        }
                    }
                    ...
                    try {
                        ...
                        IcontrolView.DisplayStatusMessage("Error writing to file in MonitorTemp.\n");
                    }
                ...
                try {
                    ...
                    IcontrolView.DisplayStatusMessage("Could not close the file in MonitorTemp.\n");
                }
                ...
                try {
                    ...
                    IcontrolView.DisplayStatusMessage(ex.getMessage());
                }


                // Display a status message
                IcontrolView.DisplayStatusMessage("Stop monitoring the temperature.\n");
            }
        }//</editor-fold>
        ...
        // Display a status message
        IcontrolView.DisplayStatusMessage("Now starting to monitor the temperature.\n");
