...
public class iC_Instrument extends Device {
    ...
    public void WaitForUser(String Message) {
        ...
        String str = "Processing of the script has be interrupted.\n"
        ...
        final JDialog MessageDialog = new JDialog(m_GUI.getFrame(),"Wait For User", false);
        ...
        MessageDialog.pack();
        MessageDialog.setLocationRelativeTo(m_GUI.getComponent());
    ...
    public void WaitDate(String DateAndTime) 
        ...
        DateFormat myDateFormat = new SimpleDateFormat("dd.MM HH:mm", Locale.US);
        myDateFormat.setLenient(true);
        ...
        if (inSyntaxCheckMode()) {
            ...
            IcontrolView.DisplayStatusMessage("Will be waiting until " + TimeString + "(still in Syntax-Check mode)\n", false);
            
            return;
        }        

        // show Status Message
        IcontrolView.DisplayStatusMessage("Waiting until " + TimeString +"\n");
    ...
    public void MonitorChart(float TimeIntervall, String YLabel, String FileExtension,
        ...
        class myThread extends Thread {
            ...
            public void run() {
                ...
                while ( m_StopScripting == false) {
                    ...
                    for (int i=0; i<m_CommandLines.size(); i++) {
                        ...
                        try {
                            ...
                            // convert to double if returned object is valid
                            // the test for null would not be
                            // TODO 2* test what happens without if and with obj=null. should be fine so delete the if
                            //if (obj != null) {
                ...
                try {
                    ...
                    IcontrolView.DisplayStatusMessage("Could not close the file in MonitorChart.\n");
                }
                ...
                IcontrolView.DisplayStatusMessage("MonitorChart has been stopped.\n");
            }
        }//</editor-fold>
        ...
        // Display a status message
        IcontrolView.DisplayStatusMessage("Now starting MonitorChart.\n");
    ...
    public void DisplayStatusMessage(String Message) {
        ...
        // show the message
        IcontrolView.DisplayStatusMessage(Message+"\n");
    }//</editor-fold>
}
