...
public class iC_GenericGPIB extends Device {
    ...
    private static final Logger m_Logger = Logger.getLogger("iC.Instruments.iC_GenericInstrument");
     ...
     * actually doe nothing and just returns.<p>
     * 
