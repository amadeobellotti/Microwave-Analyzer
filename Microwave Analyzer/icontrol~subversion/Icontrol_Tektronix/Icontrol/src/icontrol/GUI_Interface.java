// TODO add DisplayStatusMessage in this interface (was public, so rename IcontrolView.Disp... to m_GUI.
// TODO then, un-make Dispatcher.Tokenizer static and move to Utilities? add contructor that requires m_GUI
